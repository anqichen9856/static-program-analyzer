...
TEST_CASE("Evaluate Follows") {
    ...
    SECTION("Integer, Integer") {
        ...
        FollowsClause follows_clause = FollowsClause("15", "16");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE_NOTHROW(follows_clause.validate(query.synonyms));
    ...
    SECTION("Integer, Wildcard") {
        ...
        query.selected = { "ifs" };
        vector<string> answer = { "13", "21", "7" };
        FollowsClause follows_clause = FollowsClause("14", "_");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Integer, Synonym") {
        ...
        query.selected = { "ifs" };
        vector<string> answer = { "13", "21", "7" };
        FollowsClause follows_clause = FollowsClause("15", "a");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Integer") {
        ...
        query.selected = { "ifs" };
        vector<string> answer = { "13", "21", "7" };
        FollowsClause follows_clause = FollowsClause("_", "16");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Synonym") {
        ...
        query.selected = { "ifs" };
        vector<string> answer = { "13", "21", "7" };
        FollowsClause follows_clause = FollowsClause("_", "a");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Integer") {
        ...
        query.selected = { "ifs" };
        vector<string> answer = { "13", "21", "7" };
        FollowsClause follows_clause = FollowsClause("w", "17");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Wildcard") {
        ...
        query.selected = { "ifs" };
        vector<string> answer = { "13", "21", "7" };
        FollowsClause follows_clause = FollowsClause("_", "_");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Wildcard") {
        ...
        query.selected = { "ifs" };
        vector<string> answer = { "13", "21", "7" };
        FollowsClause follows_clause = FollowsClause("w", "_");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Synonym") {
        ...
        query.clauses = vector<Clause*>();
        query.selected = { "a" };
        vector<string> answer = { "11", "20", "24" };
        FollowsClause follows_clause = FollowsClause("ifs", "a");
        query.clauses.push_back(&follows_clause);
        follows_clause.evaluate(&query, query_res);
        REQUIRE(query_res->getResults(query.selected) == answer);
    }
