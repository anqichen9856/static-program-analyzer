...
TEST_CASE("Evaluate Follows*") {
    ...
    SECTION("Integer, Integer") {
        ...
        FollowsStarClause p = FollowsStarClause("4", "5");
    ...
    SECTION("Integer, Wildcard") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        FollowsStarClause p = FollowsStarClause("4", "_");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Integer, Synonym") {
        ...
        FollowsStarClause p = FollowsStarClause("4", "w");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Integer") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        FollowsStarClause p = FollowsStarClause("_", "5");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Synonym") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "5" };
        FollowsStarClause p = FollowsStarClause("_", "w");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Wildcard") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        FollowsStarClause p = FollowsStarClause("_", "_");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Integer") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        FollowsStarClause p = FollowsStarClause("a", "5");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Wildcard") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        FollowsStarClause p = FollowsStarClause("a", "_");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Synonym") {
        ...
        query.clauses = vector<Clause*>();
        query.selected = { "a" };
        vector<string> answer = { "17", "18" };
        FollowsStarClause p = FollowsStarClause("w", "a");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
