...
TEST_CASE("Evaluate Parent*") {
    ...
    SECTION("Integer, Integer") {
        ...
        ParentStarClause p = ParentStarClause("5", "10");
    ...
    SECTION("Integer, Synonym") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        ParentStarClause p = ParentStarClause("5", "a");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Integer, Wildcard") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        ParentStarClause p = ParentStarClause("5", "_");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Integer") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        ParentStarClause p = ParentStarClause("_", "10");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Synonym") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        ParentStarClause p = ParentStarClause("_", "a");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Wildcard, Wildcard") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        ParentStarClause p = ParentStarClause("_", "_");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Integer") {
        ...
        ParentStarClause p = ParentStarClause("w", "10");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Wildcard") {
        ...
        query.selected = { "w" };
        vector<string> answer = { "14", "5" };
        ParentStarClause p = ParentStarClause("w", "_");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
    ...
    SECTION("Synonym, Synonym") {
        ...
        query.clauses = vector<Clause*>();
        query.selected = { "a" };
        vector<string> answer = { "10", "11", "12", "15", "16", "6", "8" };
        ParentStarClause p = ParentStarClause("w", "a");
        query.clauses.push_back(&p);
        p.evaluate(&query, query_res);
        REQUIRE(QueryEvaluator::getInstance()->evaluateQuery(query, query_res));
        REQUIRE(query_res->getResults(query.selected) == answer);
