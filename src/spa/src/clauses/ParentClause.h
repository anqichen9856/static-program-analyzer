#ifndef TEAM21_CP_SPA_20S1_PARENTCLAUSE_H
#define TEAM21_CP_SPA_20S1_PARENTCLAUSE_H


#include "IntRelClause.h"

class ParentClause : public IntRelClause {
public:
    ParentClause(string left, string right);
...
#endif //TEAM21_CP_SPA_20S1_PARENTCLAUSE_H
