#ifndef TEAM21_CP_SPA_20S1_PARENTSTARCLAUSE_H
#define TEAM21_CP_SPA_20S1_PARENTSTARCLAUSE_H


#include "MultiStatementRelClause.h"


class ParentStarClause : public MultiStatementRelClause {
public:
    ParentStarClause(string left, string right);
...
#endif //TEAM21_CP_SPA_20S1_PARENTSTARCLAUSE_H
